...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "私はオウムです。あなたのマネをします。"
...
class ParrotIntentHandler(AbstractRequestHandler):
    """Handler for Parrot Intent."""

    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("ParrotIntent")(handler_input)

    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        user_input = ask_utils.get_slot_value(
            handler_input=handler_input, slot_name="user_message"
        )
        speak_output = user_input if isinstance(user_input, str) else ""
...
class CancelOrStopIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.predicate.is_intent_name("AMAZON.CancelIntent")(
            handler_input
        ) or ask_utils.predicate.is_intent_name("AMAZON.StopIntent")(handler_input)
...
class FallbackIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.predicate.is_intent_name("AMAZON.FallbackIntent")(
            handler_input
        )
...
sb.add_request_handler(ParrotIntentHandler())
