...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = '私はオウムです。あなたのマネをします。';
...
const ParrotIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'ParrotIntent';
    },
    handle(handlerInput) {
        const user_input = Alexa.getSlotValue(handlerInput.requestEnvelope, 'user_message');
        const speakOutput = user_input || "";
        const slotToElicit = 'user_message';
        const intent = {
            name: 'ParrotIntent',
            confirmationStatus: 'NONE',
