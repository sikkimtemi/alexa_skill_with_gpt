...
const ChatBotIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (handlerInput.attributesManager.getSessionAttributes().MESSAGES) {
            messages = handlerInput.attributesManager.getSessionAttributes().MESSAGES;
        }
        messages.push({
            "role": "user",
            "content": user_input || "こんにちは"
        });
        try {
            ...
            handlerInput.attributesManager.setSessionAttributes({MESSAGES: messages});
            messages.push({
                "role": "assistant",
                "content": speakOutput
            });
